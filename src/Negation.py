...
# Negation preprocessing function
...
# Use negation preprocessing on all reviews
...
# Train and evaluate the model with negation preprocessing
print("Feature Set 3 - Unigram + Negation")
print("-" * 50)
